...
<template>
    <Head title="Медицинский портал - контакты" />
        ...
        <div class="py-12 bg-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="lg:text-center">
                    <h2 class="text-base text-blue-600 font-semibold tracking-wide uppercase">Как с нами связаться</h2>
                ...
                <div class="mt-10 grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-3">
                    <div class="bg-blue-50 p-6 rounded-lg hover:shadow-md transition-shadow">
                    ...
                    <div class="bg-blue-50 p-6 rounded-lg hover:shadow-md transition-shadow">
                        ...
                        <div class="mt-5">
                            ...
                            <p class="mt-1 text-base text-gray-500">
                                support@medportal.ru (техподдержка)
                            </p>
                        </div>
                    </div>
                    <div class="bg-blue-50 p-6 rounded-lg hover:shadow-md transition-shadow">
